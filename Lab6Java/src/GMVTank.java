public class GMVTank extends GroundMilitaryVehicle {
    ...
    public GMVTank(Integer crewSize, String name, Integer speed, Boolean protectFromBullets, GroundMilitaryVehicle.Armor armor, Integer gunCaliber, Boolean hasActiveDefence, Boolean hasDynamicDefence) {
